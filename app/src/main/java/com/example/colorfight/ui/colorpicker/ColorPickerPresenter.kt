...
class ColorPickerPresenter<V : ColorPickerContract.View> @Inject constructor(private val networkManager: NetworkManager) :
    BasePresenter<V>(), ColorPickerContract.Presenter<V>, ColorManager.OnColorsChangedListener {

    init {
        networkManager.onColorChangedListeners.add(this)
    }
    ...
    override fun onColorChanged(counts: ColorCounts) {
